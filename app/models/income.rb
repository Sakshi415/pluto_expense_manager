class Income < ApplicationRecord
  ...
  #   next_occurrence = date + 1.month
  #   while next_occurrence.day != date.day
  ...
  #   next_occurrence = date + 2.months
  #   next_occurrence += 1.month while next_occurrence.day != date.day
  #   update_next_occurrence_for_actual(next_occurrence)
  #   amount
  # end

  # def update_next_occurrence_for_actual(next_occurrence)
  #   next_income = user.incomes.find_by(frequency: frequency, date: next_occurrence, income_type: 'actual')
  #   if next_income
